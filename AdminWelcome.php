...
?>
		...
		<div class="footer col-sm-4">
			<h1 class="title"><a href="http://localhost:8000/SMS/addSociety.php">Add Society</a></h1>
		</div>
		<div class="footer col-sm-4">
			<h1 class="title"><a href="http://localhost:8000/SMS/addPatron.php">Add Patron</a></h1>
		</div>
		<div class="footer col-sm-4">
			<h1 class="title"><a href="#">Budget Management</a></h1>
		</div>
		</div>
		</br></br>
		<div class="wrapper">
